...
import mx.ine.recyclerview.RestauranteFragment.OnListFragmentInteractionListener;
...
public class MyRestauranteRecyclerViewAdapter extends RecyclerView.Adapter<MyRestauranteRecyclerViewAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final ViewHolder holder, int position) {//este metodo realiza el dibujado de cada uno de los elementos de la lista -- se ejecuta tantos elementos tengamos en la vista de restaurantes
        ...
        //Glide.with(holder.mView).load(holder.mItem.getUrlPhoto()).into(holder.imageViewPhotoRestaurante);
        if(!holder.mItem.getUrlPhoto().isEmpty()){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public String toString() {
            return super.toString() + " '" + textViewNombreRestaurante + "'";
        }
    }
}
